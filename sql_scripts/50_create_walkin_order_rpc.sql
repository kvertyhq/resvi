-- Migration: Create Walk-In Order RPC Function
-- Description: RPC function to handle walk-in order creation with proper validation and transaction handling
...
COMMENT ON FUNCTION create_walkin_order IS 'Creates a walk-in/takeaway order with items. Returns JSON with success status and order_id.';
