                ...
                >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1.5 mr-2 pr-2 border-r border-gray-300 dark:border-gray-600">
                                <button
                                    onMouseDown={(e) => { e.preventDefault(); setMode('qwerty'); }}
                                    className={`text-xs px-3 py-1 rounded font-bold transition-all ${mode === 'qwerty' ? 'bg-[var(--theme-color)] text-white' : 'text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800'}`}
                                >ABC</button>
                                <button
                                    onMouseDown={(e) => { e.preventDefault(); setMode('numpad'); }}
                                    className={`text-xs px-3 py-1 rounded font-bold transition-all ${mode === 'numpad' ? 'bg-[var(--theme-color)] text-white' : 'text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800'}`}
                                >123</button>
                            </div>

                            <button
                                onMouseDown={(e) => { e.preventDefault(); setOpen(false); }}
                                className="p-1 px-3 bg-red-500 hover:bg-red-600 text-white rounded text-sm font-bold flex items-center gap-1 transition-colors"
