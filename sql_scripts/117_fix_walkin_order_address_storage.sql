-- Migration: Fix create_walkin_order to actually save customer_address and customer_postcode
-- Previously the RPC accepted these parameters but never inserted them into the orders table.
...
-- Step 2: Update the RPC to write these columns
...
BEGIN
    ...
    -- Create the order (now includes customer_address and customer_postcode)
    INSERT INTO orders (
        restaurant_id,
        user_id,
        staff_id,
