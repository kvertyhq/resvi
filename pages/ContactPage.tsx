        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto -mt-20 relative z-10">
            ...
            <InfoCard 
              icon={<LocationIcon />}
              title="Address"
              lines={["6th Forrest Ray, London - 10001 UK", "- Get Directions -"]}
            />
            <InfoCard 
              icon={<ClockIcon />}
              title="Opening Hours"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="h-full min-h-[400px] mt-10 lg:mt-0">
              <img src="https://i.imgur.com/L2xXQUS.png" alt="Map of London" className="w-full h-full object-cover border" />
            </div>
          </div>
        </div>
      </section>
